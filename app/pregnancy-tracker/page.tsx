    ...
    <PublicShell>
      <main className="section-pad">
        <div className="container-page">
          <SectionHeading eyebrow="Weeks 1 to 42" title="Pregnancy week by week" text="Evidence-informed weekly prompts to help you prepare questions, notice patterns and stay connected to your maternity team's advice. These guides remain out of search indexing while independent clinical review is arranged." />
          <div className="mb-8">
            <MedicalNotice />
          </div>
