      ...
      <main className="section-pad">
        <article className="container-page max-w-3xl text-slate">
          ...
          <div className="mt-8 space-y-8 text-base leading-8">
            ...
            <Section title="Information we collect"><p>We process account details such as name and email address; family workspace details such as due date and country; content you choose to add, including notes, appointments, health-tracker entries and uploaded photos or documents; invitation details; subscription identifiers from Stripe; and messages you send through Contact Us. When you request a free download, we collect your email address, the download requested, the date and whether you chose to receive marketing emails. We also use essential authentication data needed to keep you signed in securely.</p></Section>
            <Section title="Why we use it"><p>We use this information to provide your private workspace, authenticate you, enable family sharing you choose, store and retrieve uploaded files, provide support, prevent misuse, manage subscriptions, and provide a requested free download. Where required by data-protection law, our basis is performance of our contract with you, legitimate interests in operating a secure service, compliance with legal obligations, or your explicit consent for health-related information you choose to enter.</p></Section>
            <Section title="Marketing emails and free downloads"><p>We only send marketing emails when you actively opt in using the separate checkbox on a download form or another consent request. You can download a free resource without agreeing to marketing. You can withdraw marketing consent at any time by using the unsubscribe link in a marketing email or by emailing <a className="font-semibold text-coral underline underline-offset-4" href="mailto:jobyktom@gmail.com?subject=Unsubscribe%20from%20LioraBump%20marketing">jobyktom@gmail.com</a>. Withdrawing consent does not affect any processing completed before withdrawal.</p></Section>
            ...
            <Section title="Retention and deletion"><p>We keep account and workspace information while your account remains active. You can export or delete workspace data in Settings. We retain download and marketing-consent records until you withdraw consent, ask us to delete them, or we no longer need them for the purpose collected. We delete or anonymise information where practical, except for information we must retain for legal, fraud-prevention, billing or security reasons. Contact messages may remain in our support mailbox for up to 24 months.</p></Section>
